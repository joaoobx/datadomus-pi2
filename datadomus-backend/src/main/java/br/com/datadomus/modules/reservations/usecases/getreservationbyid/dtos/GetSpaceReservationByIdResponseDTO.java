package br.com.datadomus.modules.reservations.usecases.getreservationbyid.dtos;
...
@Getter
@Setter
public class GetSpaceReservationByIdResponseDTO {
    ...
    public GetSpaceReservationByIdResponseDTO(SpaceReservation spaceReservation) {
