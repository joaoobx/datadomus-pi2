package br.com.datadomus.modules.warnings.usecases.updatewarning.dtos;
...
@Getter
@Setter
public class UpdateWarningResponseDTO {
    ...
    public UpdateWarningResponseDTO(Warning warning) {
